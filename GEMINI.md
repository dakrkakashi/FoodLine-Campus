...
## 7. ⚡ Garry Tan's gstack — 23-Specialist Engineering Team Integration
- **Boil the Ocean:** AI makes completeness cheap, so build the complete thing: tests, edge cases, error handlers, and defensive recovery. Shortcuts need an explicit recorded decision.
- **The Reuse Ladder:** Stop at the first rung that holds: (1) Repo util -> (2) Standard library -> (3) Native platform -> (4) Existing installed dependency. Never add unnecessary dependencies.
- **Slash Command Team Roles:**
  - Product Interrogation: `/office-hours`
  - CEO Strategic Scope Review: `/plan-ceo-review`
  - Staff Eng Architectural Review: `/plan-eng-review`
  - Design & Anti-Slop Review: `/plan-design-review`
  - Autonomous Multi-Role Planning: `/autoplan`
  - Adversarial Code Review: `/review`
  - Headless Browser QA: `/qa`
