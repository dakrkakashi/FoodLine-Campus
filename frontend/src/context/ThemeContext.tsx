...
const applyThemeToCSS = (themeKey: ThemeName, activeMode: ThemeMode, custom: CustomColors) => {
    ...
    root.style.setProperty('--color-accent-purple', t.primary);

    // Set RGB components for pristine alpha color-mixing & gradients
    root.style.setProperty('--accent-primary-rgb', hexToRgb(t.primary));
    root.style.setProperty('--accent-secondary-rgb', hexToRgb(t.secondary));
    root.style.setProperty('--accent-accent-rgb', hexToRgb(t.accent));
    ...
    root.style.setProperty('--color-canvas', t.bgCanvas);
    ...
    // Mode-dependent typography, surfaces, and card interaction states
    if (isLight) {
      ...
      root.style.setProperty('--bg-card-hover', '#F4F4F6');
      root.style.setProperty('--bg-card-active', '#E4E4E7');
      root.style.setProperty('--color-card-hover', '#F4F4F6');
      root.style.setProperty('--color-card-active', '#E4E4E7');
      ...
      root.style.setProperty('--color-border-glass', 'rgba(0, 0, 0, 0.09)');
    } else {
      root.style.setProperty('--text-primary', '#F5F5F7');
      root.style.setProperty('--text-secondary', '#A1A1AA');
      root.style.setProperty('--text-muted', '#71717A');
      root.style.setProperty('--color-text-primary', '#F5F5F7');
      root.style.setProperty('--color-text-secondary', '#A1A1AA');
      root.style.setProperty('--color-text-muted', '#71717A');
      root.style.setProperty('--bg-card-hover', `${t.bgCard}E6`);
      root.style.setProperty('--bg-card-active', `${t.bgCard}CC`);
      root.style.setProperty('--color-card-hover', `${t.bgCard}E6`);
      root.style.setProperty('--color-card-active', `${t.bgCard}CC`);
      ...
      root.style.setProperty('--color-border-glass', 'rgba(255, 255, 255, 0.08)');
    }
