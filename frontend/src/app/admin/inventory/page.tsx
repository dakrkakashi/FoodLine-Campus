      ...
      <main className="max-w-6xl mx-auto px-4 pt-28">
        ...
        <div className="flex items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-2 text-xs text-zinc-400">
            ...
            <span>/</span>
            <span className="text-(--accent-orange) font-bold">Dual Inventory Management</span>
          </div>
        ...
        <div className="glass-card-heavy rounded-3xl p-6 md:p-8 border border-white/10 mb-8 relative overflow-hidden shadow-2xl">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-(--accent-orange)/10 border border-(--accent-orange)/30 text-(--accent-orange) text-xs font-black uppercase tracking-wider mb-3">
                <Package size={14} />
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex items-center bg-black/40 p-1.5 rounded-2xl border border-white/10">
            <button
              ...
              className={`px-5 py-2.5 rounded-xl text-xs font-black transition flex items-center gap-2 cursor-pointer ${
                activeTab === 'fresh'
                  ? 'bg-linear-to-r from-[#FF6B2C] to-[#FFB347] text-black shadow-lg shadow-[#FF6B2C]/20'
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-xl text-xs font-black transition flex items-center gap-2 cursor-pointer ${
                activeTab === 'persistent'
                  ? 'bg-linear-to-r from-[#00D4AA] to-[#38BDF8] text-black shadow-lg shadow-[#00D4AA]/20'
                  : 'text-zinc-400 hover:text-white'
              }`}
            >
              <Coffee size={15} />
          ...
          <div className="relative min-w-[260px]">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-black/50 border border-white/10 text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-(--accent-orange) transition"
            />
            {searchQuery && (
              <button
            ...
            <div className="glass-card rounded-2xl p-4 border border-white/10 flex flex-wrap items-center justify-between gap-3 bg-black/30">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-(--accent-orange)/15 border border-(--accent-orange)/30 text-(--accent-orange) text-xs font-black hover:bg-(--accent-orange) hover:text-black transition cursor-pointer flex items-center gap-1"
                >
                  <Flame size={13} />
              ...
              <button
                ...
                disabled={isSaving}
                className="px-6 py-2.5 rounded-xl bg-linear-to-r from-[#FF6B2C] to-[#FFB347] text-black font-black text-xs shadow-lg shadow-[#FF6B2C]/20 hover:scale-105 active:scale-95 transition cursor-pointer flex items-center gap-2 ml-auto"
              >
                <Save size={15} />
          ...
          <div className="space-y-6">
            ...
            <div className="glass-card rounded-2xl p-4 border border-white/10 flex flex-wrap items-center justify-between gap-3 bg-black/30">
              ...
              <button
                ...
                disabled={isSaving}
                className="px-6 py-2.5 rounded-xl bg-linear-to-r from-[#00D4AA] to-[#38BDF8] text-black font-black text-xs shadow-lg shadow-[#00D4AA]/20 hover:scale-105 active:scale-95 transition cursor-pointer flex items-center gap-2 ml-auto"
              >
                <Save size={15} />
