    ...
    <div className="min-h-screen bg-(--bg-canvas,#07070B) text-[#F5F5F7] p-4 sm:p-6 lg:p-10">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="p-5 rounded-2xl bg-(--bg-card) border border-(--border-glass) backdrop-blur-xl space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-mono uppercase text-(--text-secondary)">Test Crash Simulator</span>
            ...
            <p className="text-[11px] text-(--text-muted) font-mono">Deliberate test fault to verify error.tsx boundary</p>
          </div>
        </div>
